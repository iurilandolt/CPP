...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/18 00:05:19 by iurilandolt       #+#    #+#             */
/*   Updated: 2024/06/18 00:07:59 by iurilandolt      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv) {
	...
	if (!infile.is_open() || !infile.good())
		return (std::cerr << "Seditor: could not open file" << std::endl, 1);
    if (file_emtpy(infile))
        return (std::cerr << "Seditor: file is empty" << std::endl, 1);
